...
class BillSummaryArgs {
  final String routeTo;
  final String sheetTitle;
  final String billPinRouteTo;

  BillSummaryArgs({
    required this.routeTo,
    required this.sheetTitle,
    required this.billPinRouteTo,
  });

  factory BillSummaryArgs.empty() {
    return BillSummaryArgs(
      routeTo: '',
      sheetTitle: '',
      billPinRouteTo: '',
    );
...
class BillSummarySheet extends StatelessWidget {
  const BillSummarySheet({super.key, required this.args});
  final BillSummaryArgs args;
                  ...
                  child: AppButton(
                    ...
                    action: () {
                      AppNavigator.of(context).push(
                        args.routeTo,
                        args: BillPinArgs(
                          routeTo: args.billPinRouteTo,
                        ), //AppRoutes.billOptionsChoice
                      );
                    },
                  ),
                ),
