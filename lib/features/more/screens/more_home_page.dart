...
class _MoreHomePageState extends State<MoreHomePage> {
            ...
            onTap: isToggle
                ? () {
                    _handleBiometricToggle(
                      action['label'] as String,
                      !(action['label'] == 'Biometrics (For Password)'
                          ? biometricsForPassword
                          : biometricsForTransactionPIN),
                    );
                  }
                : () {
                    _handleNonToggleAction(action['label'] as String);
                  },
          ),
  ...
  void _handleBiometricToggle(String label, bool value) {
    setState(() {
      if (label == 'Biometrics (For Password)') {
        biometricsForPassword = value;
        if (value) {
          _navigateToBiometricsPassword(context);
        }
      } else if (label == 'Biometrics (For Transaction PIN)') {
  ...
  void _handleNonToggleAction(String label) {
    switch (label) {
