...
class BiometricsPasswordArgs {
  final String routeTo;

  BiometricsPasswordArgs({required this.routeTo});
  factory BiometricsPasswordArgs.empty() {
    return BiometricsPasswordArgs(
      routeTo: '',
    );
  }
}

class BiometricsPassword extends StatefulWidget {
  const BiometricsPassword({
    super.key,
    required this.args,
    required this.onPinEntered,
  });

  final BiometricsPasswordArgs args;
  final Function(String) onPinEntered;

  @override
  State<BiometricsPassword> createState() => _BiometricsPasswordState();
}

class _BiometricsPasswordState extends State<BiometricsPassword> {
