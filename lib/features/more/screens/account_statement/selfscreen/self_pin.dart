...
class SelfPinArgs {
  ...
  SelfPinArgs({required this.routeTo});
  factory SelfPinArgs.empty() {
    return SelfPinArgs(
      routeTo: '',
    );
  }
...
class SelfPin extends StatefulWidget {
  const SelfPin({
    super.key,
    required this.args,
  ...
  final SelfPinArgs args;
  final Function(String) onPinEntered;

  @override
  State<SelfPin> createState() => _SelfPinState();
}

class _SelfPinState extends State<SelfPin> {
