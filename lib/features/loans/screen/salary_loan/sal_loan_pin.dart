...
class SalLoanPinArgs {
  final String routeTo;

  const SalLoanPinArgs({required this.routeTo});

  factory SalLoanPinArgs.empty() => const SalLoanPinArgs(routeTo: '');
}

class SalLoanPin extends StatefulWidget {
  final SalLoanPinArgs args;
  ...
  @override
  State<SalLoanPin> createState() => _SalLoanPinState();
}

class _SalLoanPinState extends State<SalLoanPin> {
