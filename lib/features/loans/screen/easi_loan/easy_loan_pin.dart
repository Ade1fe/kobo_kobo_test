...
import 'package:kobo_kobo/features/loans/screen/salary_loan/confirmation_screen.dart';
...
class EasyLoanPinArgs {
  final String routeTo;
  final String guarantorType;

  EasyLoanPinArgs({required this.routeTo, required this.guarantorType});
  factory EasyLoanPinArgs.empty() {
    return EasyLoanPinArgs(
      routeTo: '',
      guarantorType: '',
    );
  }
...
class EasyLoanPin extends StatefulWidget {
  const EasyLoanPin({
    super.key,
    required this.args,
  ...
  final EasyLoanPinArgs args;
  final Function(String) onPinEntered;

  @override
  State<EasyLoanPin> createState() => _EasyLoanPinState();
}

class _EasyLoanPinState extends State<EasyLoanPin> {
  ...
  void _showSuccessModal(BuildContext context) {
    if (widget.args.guarantorType == 'external') {
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) => ConfirmationScreen(
            onConfirm: () {
              widget.onPinEntered(_otpTEC.text);
              Log().debug('the pin is ${widget.args.routeTo.isNotEmpty}');
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Your loan request has been successful',
                  // style: TextStyle(
                  //   fontSize: 18.sp,
