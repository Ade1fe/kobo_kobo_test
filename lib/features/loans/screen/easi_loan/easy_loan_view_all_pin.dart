...
class EasyLoanViewAllPinArgs {
  final String routeTo;

  EasyLoanViewAllPinArgs({required this.routeTo});

  factory EasyLoanViewAllPinArgs.fromMap(Map<String, String> map) {
    return EasyLoanViewAllPinArgs(
      routeTo: map['routeTo'] ?? '',
    );
  }

  // Optional empty constructor
  EasyLoanViewAllPinArgs.empty() : routeTo = '';
}

class EasyLoanViewAllPin extends StatefulWidget {
  const EasyLoanViewAllPin({
    super.key,
    required this.args,
    required this.onPinEntered,
  });

  final EasyLoanViewAllPinArgs args;
  final Function(String) onPinEntered;

  @override
  State<EasyLoanViewAllPin> createState() => _EasyLoanViewAllPinState();
}

class _EasyLoanViewAllPinState extends State<EasyLoanViewAllPin> {
